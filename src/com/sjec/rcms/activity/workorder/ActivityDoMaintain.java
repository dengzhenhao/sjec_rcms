 ...
 */
public class ActivityDoMaintain extends BaseActivity {
...
//
//	private TextView tv_base_info, tv_maintain, tv_workorder_status,tv_workorder_starttime,
//			et_workorder_remark, tv_workorder_receiver, tv_workorder_desc,tv_workorder_device_num,tv_workorder_event_source;
//
...
//			if(intent.getAction().equals("refresh_workorder")){
...
//			Intent intent = new Intent(ActivityDoMaintain.this,
...
//			b.putInt("type", ActivityPauseReason.TYPE_REQ_MAINTAIN_CHANGEDATE);
//			Util.startActivity(ActivityDoMaintain.this, ActivityPauseReason.class, b,false);
//
//			break;
//		case R.id.btn_continue_workorder:
//			b.putString("title", "继续工作");
//			b.putInt("type", ActivityPauseReason.TYPE_REQ_CONTINUE);
//			Util.startActivity(ActivityDoMaintain.this, ActivityPauseReason.class, b,false);
//			break;
//		case R.id.btn_disable_workorder:
//			b.putString("title", "请求作废");
//			b.putInt("type", ActivityPauseReason.TYPE_REQ_DISABLE);
//			Util.startActivity(ActivityDoMaintain.this, ActivityPauseReason.class, b,false);
//			break;
...
//				} catch (Exception e) {
//					e.printStackTrace();
//					Util.createToast(ActivityDoMaintain.this,
...
//	@Override
//	public void init() {
//IntentFilter filter = new IntentFilter("refresh_workorder");
...
//		btn_complete_workorder_qr.setBackgroundResource(R.drawable.frame_disabled);
//		
//	}
//
//	@Override
//	public void bindData() {
//		if (AppData.PRE_PACKAGE_NAME.isEmpty()) {
//			initParam();
//		}
...
//		{
//			tv_workorder_status_pause.setText("正常");
//		}else{
//			if(GlobalData.curWorkorder.OrderPause == 0)
//			{
//				tv_workorder_status_pause.setText("延期");
//			}else if(GlobalData.curWorkorder.OrderPause == 1)
//			{
//				tv_workorder_status_pause.setText("正常");
//			}
////			else if(GlobalData.curWorkorder.OrderPause == -1)
////			{
////				tv_workorder_status_pause.setText("废弃");
////			}else if(GlobalData.curWorkorder.OrderPause == 99)
////			{
////				tv_workorder_status_pause.setText("待审核");
////			}
//		}
...
//			
//			btn_continue_workorder.setEnabled(false);
//			btn_delay_workorder.setEnabled(false);
//			
//			btn_continue_workorder.setBackgroundResource(R.drawable.frame_disabled);
//			btn_delay_workorder.setBackgroundResource(R.drawable.frame_disabled);
//			
//			if (GlobalData.curWorkorder.ChargeUserID == null
//					|| GlobalData.curWorkorder.ChargeUserID.isEmpty()) {
//				//未受理
...
//					btn_delay_workorder.setBackgroundResource(R.drawable.frame_disabled);
//				}else{
//					if(GlobalData.curWorkorder.OrderPause == -1 || GlobalData.curWorkorder.OrderPause == 0||GlobalData.curWorkorder.OrderPause == 99){
//						
//						btn_continue_workorder.setEnabled(true);
//						btn_delay_workorder.setEnabled(false);
//						
//						btn_continue_workorder.setBackgroundResource(R.drawable.frame_app);
//						btn_delay_workorder.setBackgroundResource(R.drawable.frame_disabled);
//					}else{ 
//						btn_continue_workorder.setEnabled(false);
//						btn_delay_workorder.setEnabled(true);
//						
//						btn_continue_workorder.setBackgroundResource(R.drawable.frame_disabled);
//						btn_delay_workorder.setBackgroundResource(R.drawable.frame_app);
//					}
//				}
//			}
//			
...
//		new SJECHttpHandler(callBackQueryDevice, this).getDeviceByWorkorderID(
//				GlobalData.curUser.InnerID, workorder_id);
//		new SJECHttpHandler(callBackWorkorder, this).getWorkorderByID(
//				GlobalData.curUser.InnerID, workorder_id);
//		
//		new SJECHttpHandler(callBackPushLog, this).getWorkorderPushLogByID(
//				GlobalData.curUser.InnerID, workorder_id);
//
//	}
//	
...
//		new SJECHttpHandler(callBackUpdateStatus, this).updateWorkorderStatus(
...
//				.updateWorkorderReceiver(GlobalData.curUser.InnerID,
//						workorder_id);
//	}
//	
//	
...
//		LayoutInflater mInflater = LayoutInflater.from(ActivityDoMaintain.this);
//
...
//		 
//			tv_push_time.setText(DateUtil.TimeParseStringToFormatString( listPushLog.get(i).PushTime,"yyyy-MM-dd HH:mm"));
...
//					if (GlobalData.curWorkorder.Type == EnumWorkorderType.TYPE_WORKORDER_1) {
