package com.sjec.rcms.activity.qr;
...
public class CaptureActivity extends BaseActivity {
	...
	// 1:扫描设备二维号,跳转到采集页面
	private int scan_type = Constant.SCAN_TYPE1;
	...
	public void init(Bundle savedInstanceState) {
		...
		scan_type = b.getInt("scan_type", Constant.SCAN_TYPE1);
		findViewById();
		addEvents();
		initViews();
	}
	...
	PreviewCallback previewCb = new PreviewCallback() {
		public void onPreviewFrame(byte[] data, Camera camera) {
			...
			if (!TextUtils.isEmpty(result)) {
				...
				releaseCamera();
				Intent intent = null;
				if (scan_type == Constant.SCAN_TYPE1) {
					Bundle b = new Bundle();
					b.putString("data", result);
					b.putInt("type", 2);
					Util.startActivity(CaptureActivity.this, ActivityCollectInfoV2.class, b, true);
				} else if (scan_type == Constant.SCAN_TYPE2) {
					intent = new Intent(
				...
				else if (scan_type == Constant.SCAN_TYPE3) {
				...
				else if (scan_type == Constant.SCAN_TYPE4) {
					 Intent mIntent = new Intent(); 
					Bundle b = new Bundle();
					b.putString("data", result);
					mIntent.putExtras(b);
