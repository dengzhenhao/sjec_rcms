 ...
 */
public class AdapterKunrenList extends CListView {

	public AdapterKunrenList(PullToRefreshListView lv, Activity activity) {
		super(lv, activity);
