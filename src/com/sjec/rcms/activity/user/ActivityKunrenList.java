...
public class ActivityKunrenList extends BaseActivity {

	private PullToRefreshListView lv_pause;
	private AdapterKunrenList adapterKunrenList;
	...
	public void bindData() {
		tv_title.setText("困人工单");
		layout_back.setOnClickListener(this);
		//lv_pause.setMode(Mode.)
		adapterKunrenList = new AdapterKunrenList(lv_pause , this);
