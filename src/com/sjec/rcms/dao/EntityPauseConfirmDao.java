...
/** 
 * DAO for table ENTITY_PAUSE_CONFIRM.
*/
public class EntityPauseConfirmDao extends AbstractDao<EntityPauseConfirm, Void> {

    public static final String TABLENAME = "ENTITY_PAUSE_CONFIRM";

    /**
     * Properties of entity EntityPauseConfirm.<br/>
    ...
    */
    public static class Properties {
        ...
        public final static Property Village_Name = new Property(12, String.class, "Village_Name", false, "VILLAGE__NAME");
        public final static Property Workorder_Remark = new Property(13, String.class, "Workorder_Remark", false, "WORKORDER__REMARK");
    };


    public EntityPauseConfirmDao(DaoConfig config) {
        super(config);
    }
    
    public EntityPauseConfirmDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'ENTITY_PAUSE_CONFIRM' (" + //
                ...
                "'VILLAGE__NAME' TEXT," + // 12: Village_Name
                "'WORKORDER__REMARK' TEXT);"); // 13: Workorder_Remark
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'ENTITY_PAUSE_CONFIRM'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, EntityPauseConfirm entity) {
        stmt.clearBindings();
        ...
        if (Village_Name != null) {
            stmt.bindString(13, Village_Name);
        }
 
        String Workorder_Remark = entity.getWorkorder_Remark();
        if (Workorder_Remark != null) {
            stmt.bindString(14, Workorder_Remark);
        }
    }
    ...
    /** @inheritdoc */
    @Override
    public EntityPauseConfirm readEntity(Cursor cursor, int offset) {
        EntityPauseConfirm entity = new EntityPauseConfirm( //
            ...
            cursor.isNull(offset + 12) ? null : cursor.getString(offset + 12), // Village_Name
            cursor.isNull(offset + 13) ? null : cursor.getString(offset + 13) // Workorder_Remark
        );
        return entity;
    }
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, EntityPauseConfirm entity, int offset) {
        ...
        entity.setVillage_Name(cursor.isNull(offset + 12) ? null : cursor.getString(offset + 12));
        entity.setWorkorder_Remark(cursor.isNull(offset + 13) ? null : cursor.getString(offset + 13));
     }
    
    /** @inheritdoc */
    @Override
    protected Void updateKeyAfterInsert(EntityPauseConfirm entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Void getKey(EntityPauseConfirm entity) {
        return null;
    }
